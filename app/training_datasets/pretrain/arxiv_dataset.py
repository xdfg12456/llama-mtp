...
def preprocess_datasets(split="train", max_seq_length=4096):
    data_files = {
        "train": "hf://datasets/scillm/scientific_papers-archive/scientific_papers_arxiv_train.jsonl",
        "validation": "hf://datasets/scillm/scientific_papers-archive/scientific_papers_arxiv_val.jsonl",
        "test": "hf://datasets/scillm/scientific_papers-archive/scientific_papers_arxiv_test.jsonl",
    }
